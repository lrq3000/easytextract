...
a = Analysis([os.path.join('easytextract', 'easytextract.py')],
             ...
             hiddenimports=[os.path.join(cur_path, 'easytextract', 'csg_fileutil_libs'), 'pdfminer', 'python-docx2txt'] + textract_all_parsers_imports,  # hidden python files sublibraries that are necessary
             hookspath=[],
             runtime_hooks=[],
             excludes=['pandas', 'numpy', 'matplotlib', 'mpl-data', 'zmq', 'IPython', 'ipykernel', 'tcl', 'Tkinter', 'jupyter_client', 'ipywidgets', 'ipython', 'ipython_genutils', 'jupyter_core'],
